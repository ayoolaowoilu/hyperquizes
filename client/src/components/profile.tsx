      ...
      <main className="relative z-10 container mx-auto px-4 py-12 lg:py-20">
        ...
        <div className="max-w-4xl mx-auto mb-16 text-center">
          ...
          <h1 className={`text-4xl lg:text-5xl font-black mb-4 transition-colors duration-300 ${isDark ? 'text-white' : 'text-slate-900'}`}>
            Profile <span className="text-transparent bg-clip-text bg-linear-to-r from-orange-500 to-amber-500">Settings</span>
          </h1>
        ...
        <div className="max-w-4xl mx-auto space-y-8">
          ...
          <div className={`rounded-3xl p-8 border backdrop-blur-sm ${isDark ? 'bg-black/60 border-orange-500/20' : 'bg-white border-orange-100'}`}>
            <div className="flex items-center gap-4 mb-6">
              <div className="w-16 h-16 rounded-full bg-linear-to-br from-orange-500 to-orange-600 flex items-center justify-center text-white font-bold text-2xl shadow-lg shadow-orange-500/30">
                {avatarLetter}
              </div>
              <div>
            ...
            <form onSubmit={handleUpdateProfile} className="space-y-5">
              ...
              <div className="flex items-center justify-between pt-4">
                ...
                <button
                  type="submit"
                  disabled={isUpdating}
                  className={`ml-auto px-6 py-3 rounded-xl font-semibold transition-all duration-300 flex items-center gap-2 ${isUpdating ? 'opacity-70 cursor-not-allowed' : 'hover:scale-105 hover:shadow-lg'} ${isDark ? 'bg-linear-to-r from-orange-600 to-orange-500 text-white hover:shadow-[0_0_20px_rgba(249,115,22,0.4)]' : 'bg-slate-900 text-white hover:bg-slate-800'}`}
                >
                  {isUpdating ? (
                    <>
